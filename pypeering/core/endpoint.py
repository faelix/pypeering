...
from pypeering.core.response import Record, RecordSet
...
class Endpoint(object):
    ...
    def create(self, *args, **kwargs):
        ...
        >>> device = peering.dcim.devices.create(
        ...    name='test',
        ...    device_role=1,
        ... )
        >>>
    ...
    def update(self, objects):
        ...
        >>> device = peering.dcim.devices.update([
        ...    {'id': 1, 'name': 'test'},
        ...    {'id': 2, 'name': 'test2'},
        ... ])
        >>> True
    ...
    def delete(self, objects):
        ...
        >>> peering.dcim.devices.delete(peering.dcim.devices.all(0))
        >>>

        Use bulk deletion by passing a list of ids:

        >>> peering.dcim.devices.delete([2, 243, 431, 700])
        >>>

        Use bulk deletion to delete objects eg. when filtering
        on a `custom_field`:
        >>> peering.dcim.devices.delete([
        >>>         d for d in peering.dcim.devices.all(0) \
