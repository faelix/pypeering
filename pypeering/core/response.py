...
import pypeering.core.app
from six.moves.urllib.parse import urlsplit
from pypeering.core.query import Request, RequestError
from pypeering.core.util import Hashabledict
...
class RecordSet(object):
    ...
    def delete(self):
        ...
        >>> peering.dcim.devices.filter(site_id=1, status="offline").delete()
        >>>
        """
...
class Record(object):
    ...
    a ``Record`` made from a nested response) then pypeering will make a
    ...
    def _endpoint_from_url(self, url):
        ...
        return getattr(pypeering.core.app.App(self.api, app), name)
    ...
    def serialize(self, nested=False, init=False):
        ...
        can be turned into the json that peering is expecting.
