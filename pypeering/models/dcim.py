...
from pypeering.core.endpoint import RODetailEndpoint
from pypeering.models.ipam import IpAddresses
from pypeering.models.circuits import Circuits
    ...
    def trace(self):
        ...
        for (termination_a_data, cable_data, termination_b_data) in req:
            ...
            for hop_item_data in (termination_a_data, cable_data, termination_b_data):
                ...
                #     https://peering/api/dcim/rear-ports/12761/
...
class Devices(Record):
    ...
    Represents a device response from peering.
